...
typedef ERAppLifecycleStateNotifier = ValueNotifier<AppLifecycleState>;

class ERAppLifecycleObserver extends StatefulWidget {
  final Widget child;

  const ERAppLifecycleObserver({required this.child, super.key});

  @override
  State<ERAppLifecycleObserver> createState() => _ERAppLifecycleObserverState();
}

class _ERAppLifecycleObserverState extends State<ERAppLifecycleObserver> {
  ...
  Widget build(BuildContext context) {
    ...
    return InheritedProvider<ERAppLifecycleStateNotifier>.value(
