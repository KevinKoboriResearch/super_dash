...
class Background extends ParallaxComponent {
  ...
  Future<void> onLoad() async {
    final layers = [
      ParallaxImageData('endless_runner/scenery/background.png'),
      ParallaxImageData('endless_runner/scenery/clouds.png'),
      ParallaxImageData('endless_runner/scenery/cliffs.png'),
      ParallaxImageData('endless_runner/scenery/trees.png'),
      ParallaxImageData('endless_runner/scenery/ground.png'),
    ];
