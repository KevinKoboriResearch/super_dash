  ...
  Future<void> onLoad() async {
    ...
    animations = {
      PlayerState.running: await game.loadSpriteAnimation(
        'endless_runner/dash/dash_running.png',
      ...
      PlayerState.jumping: SpriteAnimation.spriteList(
        [await game.loadSprite('endless_runner/dash/dash_jumping.png')],
        stepTime: double.infinity,
      ),
      PlayerState.falling: SpriteAnimation.spriteList(
        [await game.loadSprite('endless_runner/dash/dash_falling.png')],
        stepTime: double.infinity,
      ),
    };
